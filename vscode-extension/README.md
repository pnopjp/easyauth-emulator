...
>
> **Restricted Mode / virtual workspaces** — Not supported. The extension stays disabled in Restricted Mode (untrusted workspace) and in virtual workspaces (e.g. GitHub Repositories). Trust the workspace to use it.
